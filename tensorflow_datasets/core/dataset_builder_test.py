...
class DatasetBuilderMultiDirTest(testing.TestCase):
  ...
  def setUp(self):
    ...
    self.other_data_dir = os.path.join(self.get_temp_dir(), "data_dir")
    tf.io.gfile.makedirs(self.other_data_dir)
    self.default_data_dir = os.path.expanduser(constants.DATA_DIR)
